...
class GhostControlBox : ThemeControl154
{
    ...
    protected override void OnClick(System.EventArgs e)
    {
        ...
        {
           // Clipboard.SetText(HWIDGrabber.GetUHI);
            MessageBox.Show( "Cod3d By RedMant", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        else if (X > 44)
        {
            FindForm().Close();
    ...
    protected override void PaintHook()
    {
        ...
        if (FindForm().WindowState != FormWindowState.Maximized)
            G.DrawString("a", new Font("Marlett", 10F), Brushes.White, new Point(27, 4));
        else
