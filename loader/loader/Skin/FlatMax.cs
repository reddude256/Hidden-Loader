...
internal class FlatMax : Control
{
	...
	protected override void OnPaint(PaintEventArgs e)
	{
		...
		{
			graphic.DrawString("1", this.Font, new SolidBrush(this.TextColor), new Rectangle(1, 1, base.Width, base.Height), Helpers.CenterSF);
		}
		else if (base.FindForm().WindowState == FormWindowState.Normal)
		{
			graphic.DrawString("2", this.Font, new SolidBrush(this.TextColor), new Rectangle(1, 1, base.Width, base.Height), Helpers.CenterSF);
		}
		switch (this.State)
		{
